...
const products: Product[] = [
  ...
  { id: 4, name: 'Monitor', price: 399.99, category: 'Electronics', inStock: true },
  { id: 5, name: 'Keyboard', price: 79.99, category: 'Electronics', inStock: true },
];

const tasks: Task[] = [
  { id: 1, title: 'Complete project setup', completed: true, priority: 'high', assignedTo: 1 },
  { id: 2, title: 'Write documentation', completed: false, priority: 'medium', assignedTo: 2 },
  { id: 3, title: 'Review pull requests', completed: false, priority: 'high', assignedTo: 1 },
  { id: 4, title: 'Fix bug #123', completed: true, priority: 'low', assignedTo: 3 },
  { id: 5, title: 'Deploy to staging', completed: false, priority: 'medium', assignedTo: 2 },
];
